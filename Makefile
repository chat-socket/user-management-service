REPO=user-management-service
TIMESTAMP=tmp-$(shell date +%s )
DFILE=user-management-service/deployment.yml
SFILE=user-management-service/svc.yml
VERSION=v1
TEST_PATH=Documents/projects/microservices-chat-app/user-management-service
